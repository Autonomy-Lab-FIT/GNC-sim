function run_LQR()
    ...
    x_target = zeros(13, 1);
    x_target(7) = 1;
    x_target(3) = -0.0; % Target z=0.0m (Origin)
    ...
    config_lqr = struct();
    config_lqr.weights.position = 2;
    config_lqr.weights.velocity = 2; 
    config_lqr.weights.att = 2;
    config_lqr.weights.ang_vel = 10;
    config_lqr.control_weights = [5, 20, 20, 20];
    ...
    while t < flight_duration
        ...
        [K, ~] = compute_k_matrix(A, B, config_lqr, px4_config); 
